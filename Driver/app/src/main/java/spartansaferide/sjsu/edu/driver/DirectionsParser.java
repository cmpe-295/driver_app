...
/**
 * Created by balaji.byrandurga on 11/14/16.
 */
...
public class DirectionsParser {
                ...
                for (int j = 0; j < jsonLegs.length(); j++) {
                    ...
                    for (int k = 0; k < jsonSteps.length(); k++) {
                        ...
                        for (int l = 0; l < list.size(); l++) {
                            ...
                            map.put("lat", Double.toString(((LatLng) list.get(l)).latitude));
                            map.put("lng", Double.toString(((LatLng) list.get(l)).longitude));
                            path.add(map);
                        }
                    }
                    routes.add(path);
    ...
    private List<LatLng> decode(String encoded) {
